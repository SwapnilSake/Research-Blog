...
<section class="dashboard">
    <?php if(isset($_SESSION['add-user-success'])) : //shows id add user successful?> 
    ...
    <?php elseif(isset($_SESSION['edit-user'])) : //shows if edit user was successful?>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                <li>
                    <a href="contacts.php" ><i class="fa fa-comments-o" style="font-size:15px"></i>
                    <h5>Contacts</h5>
                    </a>
                </li>
                <li>
